...
export const siteContent: SiteContent = {
  ...
  codex: [
    ...
    },
    {
      ...
      relatedArchiveIds: ["off-ledger-run", "rouxline"],
    ...
    },
    {
      ...
      relatedArchiveIds: ["off-ledger-run", "gate-8", "rouxline"],
    ...
    },
    {
      ...
      relatedArchiveIds: ["rouxline", "lowline-runs"],
      relatedCharacterIds: ["kellan-roux", "gio-roux"],
      relatedCircuitIds: ["neo-noctis"],
      image: asset("ref-city.jpg"),
    },
    {
      ...
      relatedArchiveIds: ["rouxline", "gate-8", "lowline-runs"],
    ...
    },
    {
      ...
      relatedArchiveIds: ["rouxline", "uno-handler"],
    ...
    },
    {
      ...
      relatedArchiveIds: ["uno-handler", "rouxline"],
